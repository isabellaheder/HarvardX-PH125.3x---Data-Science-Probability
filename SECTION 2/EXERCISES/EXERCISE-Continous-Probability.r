# QUESTION 1: Distribution of female heights - 1
...
# QUESTION 2: Distribution of female heights - 2
# Assume the distribution of female heights is approximated by a normal distribution 
...
# Using variables 'female_avg' and 'female_sd', calculate the 
# probability that a randomly selected female is 6 feet or taller. 
# Print this value to the console.
1 - pnorm(72, female_avg, female_sd)

# QUESTION 3: Distribution of female heights - 3
...
# Using variables 'female_avg' and 'female_sd', calculate the 
# probability that a randomly selected female is between the 
# desired height range. Print this value to the console.
pnorm(67, female_avg, female_sd) - pnorm(61, female_avg, female_sd)


# QUESTION 4: Distribution of female heights - 4
...
# Convert female_avg to centimeters.
female_avg <- 64*2.54

# Convert female_sd to centimeters.
female_sd <- 3*2.54
...
# QUESTION 5: Probability of 1 SD from average
...
# To a variable named 'taller', assign the value of a height that is 
# one SD taller than average.
taller <- female_avg + female_sd

# To a variable named 'shorter', assign the value of a height 
# that is one SD shorter than average.
...
# QUESTION 6: Distribution of male heights
# Imagine the distribution of male adults is approximately normal with an average 
# of 69 inches and a standard deviation of 3 inches. How tall is a male in the 99th percentile?
...
# QUESTION 7: Distribution of IQ scores
...
# distribution of the person with the highest IQ in your school district, where 
# 10,000 people are born each year. Generate 10,000 IQ scores 1,000 times using a 
# Monte Carlo simulation. Make a histogram of the highest IQ scores.
...
# Create an object called `highestIQ` that contains the highest 
# IQ score from each random distribution of 10,000 people.
